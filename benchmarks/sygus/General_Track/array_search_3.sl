(set-logic LIA)
(synth-fun findIdx ( (y1 Int) (y2 Int) (y3 Int) (k1 Int)) Int ((Start Int ( 0 1 2 3 y1 y2 y3 k1 (ite BoolExpr Start Start)(+ Start Start) (- Start Start) (* Start Start) )) (BoolExpr Bool ((< Start Start) (<= Start Start) (> Start Start) (>= Start Start)))))
(declare-var x1 Int)
(declare-var x2 Int)
(declare-var x3 Int)
(declare-var k Int)
